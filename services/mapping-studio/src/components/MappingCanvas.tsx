...
const ns = {
  ...
  example: { color: "#6b7280", fontFamily: "monospace", fontSize: 10, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  meta: { color: "#4b5563", fontSize: 10 },
  handle: { background: "#475569", width: 10, height: 10, border: "2px solid #21262d" },
};
...
const ds = {
  ...
  title: { margin: "0 0 8px", color: "#60a5fa", fontSize: 16 },
  sub: { color: "#94a3b8", fontSize: 12, lineHeight: 1.7, margin: "0 0 16px", fontFamily: "monospace" },
  label: { display: "block", color: "#94a3b8", fontSize: 12, marginBottom: 4, marginTop: 12 },
  select: {
    width: "100%", background: "#0f1117", border: "1px solid #30363d",
    borderRadius: 4, color: "#e2e8f0", padding: "6px 8px", fontSize: 13,
  },
  textarea: {
    width: "100%", background: "#0f1117", border: "1px solid #30363d",
    borderRadius: 4, color: "#e2e8f0", padding: "6px 8px", fontSize: 12,
    resize: "vertical" as const, fontFamily: "system-ui, sans-serif",
  },
  btns: { display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 20 },
  cancel: {
    background: "transparent", border: "1px solid #374151", color: "#94a3b8",
    borderRadius: 5, padding: "7px 18px", cursor: "pointer", fontSize: 13,
  },
  confirm: {
    background: "#1d4ed8", border: "none", color: "#fff",
    borderRadius: 5, padding: "7px 18px", cursor: "pointer", fontSize: 13, fontWeight: 600,
  },
};
