...
const s = {
  ...
  toggle: { fontSize: 11, color: "var(--text-muted)", cursor: "pointer", display: "flex", alignItems: "center" },
  ...
  caret: { color: "var(--text-dim)", width: 10 },
  bucketName: { fontWeight: 600, color: "var(--accent)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  bucketCount: { color: "var(--text-muted)", fontSize: 10, flexShrink: 0 },
  pathRow: {
  ...
  pathName: { display: "block", color: "var(--text-main)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" as const },
  targetInfo: { display: "flex", flexWrap: "wrap" as const, gap: 4, marginTop: 2 },
  targetTag: { color: "var(--accent)", fontSize: 10, fontWeight: 500, cursor: "pointer" },
  targetTagGroup: { display: "flex", alignItems: "center", gap: 2, background: "var(--bg-root)", padding: "1px 4px", borderRadius: 3, border: "1px solid var(--border)" },
  removeBtn: { background: "transparent", border: "none", color: "var(--text-muted)", cursor: "pointer", fontSize: 12, padding: "0 2px", lineHeight: 1 },
  example: {
    display: "block", color: "var(--text-muted)", fontSize: 10, fontFamily: "monospace",
